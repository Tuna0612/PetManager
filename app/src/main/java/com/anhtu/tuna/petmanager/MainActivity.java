...
import com.anhtu.tuna.petmanager.adapter.AlbumAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void prepareAlbums() {
        int[] covers = new int[]{
                R.drawable.image_dog_husky,
                R.drawable.image_cat_egyptian_mau,
                R.drawable.image_dog_becgie,
                R.drawable.image_cat_himalaya,
                R.drawable.image_dog_pooldy,
                R.drawable.image_cat_laperm,
                R.drawable.image_dog_samoyed,
                R.drawable.image_cat_maine_coon,
                R.drawable.image_dog_golden,
                R.drawable.image_cat_peterbald,
                R.drawable.image_dog_alaska,
